...
describe('browserUtil', function() {
	var browserUtil = dm.browserUtil;
	...
	var IE7_UA = 'mozilla/4.0 (compatible; msie 7.0; windows nt 6.0; slcc1; .net clr 2.0.50727; .net clr 3.5.30729; .net clr 3.0.30729)',
		...
		IE11_COMPAT8_UA = 'mozilla/4.0 (compatible; msie 8.0; windows nt 6.1; win64; x64; trident/7.0; .net clr 2.0.50727; slcc2; .net clr 3.5.30729; .net clr 3.0.30729; media center pc 6.0; .net4.0c; .net4.0e; infopath.3)';

	describe('.getIECompatibility().isIE', function() {
		it('at chrome browser, return false.', function() {
			expect( browserUtil.getIECompatibility(CHROME_UA).isIE ).toEqual(false);
		});
		it('at firefox browser, return false.', function() {
			expect( browserUtil.getIECompatibility(FIREFOX_UA).isIE ).toEqual(false);
		});
		it('at safari browser, return false.', function() {
			expect( browserUtil.getIECompatibility(SAFARI_UA).isIE ).toEqual(false);
		});

		it('at ie7 browser, return true.', function() {
			expect( browserUtil.getIECompatibility(IE7_UA).isIE ).toEqual(true);
		});

		it('at ie8 browser, return true.', function() {
			expect( browserUtil.getIECompatibility(IE8_UA).isIE ).toEqual(true);
		});
		it('at ie8 browser compat view, return true.', function() {
			expect( browserUtil.getIECompatibility(IE8_COMPAT_UA).isIE ).toEqual(true);
		});

		it('at ie9 browser, return true.', function() {
			expect( browserUtil.getIECompatibility(IE9_UA).isIE ).toEqual(true);
		});
		it('at ie9 browser compat view, return true.', function() {
			expect( browserUtil.getIECompatibility(IE9_COMPAT_UA).isIE ).toEqual(true);
		});

		it('at ie10 browser, return true.', function() {
			expect( browserUtil.getIECompatibility(IE10_UA).isIE ).toEqual(true);
		});
		it('at ie10 browser compat view, return true.', function() {
			expect( browserUtil.getIECompatibility(IE10_COMPAT_UA).isIE ).toEqual(true);
		});
	...
	describe('.getIECompatibility().isCompatibilityMode', function() {
		it('at ie7 browser, return false.', function() {
			expect( browserUtil.getIECompatibility(IE7_UA).isCompatibilityMode ).toEqual(false);
		});

		it('at ie8 browser, return false.', function() {
			expect( browserUtil.getIECompatibility(IE8_UA).isCompatibilityMode ).toEqual(false);
		});
		it('at ie8 browser compat view, return true.', function() {
			expect( browserUtil.getIECompatibility(IE8_COMPAT_UA).isCompatibilityMode ).toEqual(true);
		});

		it('at ie9 browser, return false.', function() {
			expect( browserUtil.getIECompatibility(IE9_UA).isCompatibilityMode ).toEqual(false);
		});
		it('at ie9 browser compat view, return true.', function() {
			expect( browserUtil.getIECompatibility(IE9_COMPAT_UA).isCompatibilityMode ).toEqual(true);
		});

		it('at ie10 browser, return false.', function() {
			expect( browserUtil.getIECompatibility(IE10_UA).isCompatibilityMode ).toEqual(false);
		});
		it('at ie10 browser compat view, return true.', function() {
			expect( browserUtil.getIECompatibility(IE10_COMPAT_UA).isCompatibilityMode ).toEqual(true);
		});
