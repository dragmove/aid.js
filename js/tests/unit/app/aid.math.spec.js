  ...
  describe('aid.math', function () {
    ...
    describe('.getHeightOfRightTriangle()', function () {
      it('input arguments are not Object type, throw TypeError.', function () {
        var ERROR_MSG = 'math.getHeightOfRightTriangle() requires Number parameters.';
    ...
    describe('.getOrthogonalPointBetweenLineAndSomePoint()', function () {
      ...
      it('input arguments are not Object type, throw TypeError.', function () {
        var ERROR_MSG = 'math.getOrthogonalPointBetweenLineAndSomePoint() requires Object parameters.';
      ...
      it('input arguments are not object has x, y property of Number type, throw Error.', function () {
        var ERROR_MSG = 'math.getOrthogonalPointBetweenLineAndSomePoint() requires object parameters have x, y property.';
        ...
        expect(function () {
          ...
          math.getOrthogonalPointBetweenLineAndSomePoint(point1, {
            foo: 0,
            bar: 0
          }, somePoint);
