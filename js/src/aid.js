(function() {
    ...
    aid.namespace = function(namespace, parent) {
        if (!aid.isString(namespace))
            throw new TypeError('namespace parameter type of aid.namespace() must be String.');
    ...
    aid.borrow = function borrow(borrower, donor, functionName) {
        ...
        if (!aid.isString(functionName))
            throw new TypeError('functionName parameter type of aid.borrow() must be String.');
        ...
        aid.each(
            ...
            function(value) {
                if (!aid.isFunction(value))
                    throw new TypeError('rest parameters type of aid.pipeline() must be Function.');
            },
            null
        );
    ...
    string.getUriCombinedParams = function getUriCombinedParams(uri, parameters) {
        if (!aid.isString(uri))
            throw new TypeError('uri parameter type of string.getUriCombinedParams() must be String.');
    ...
    string.getObjCheckYoutubeURI = function getObjCheckYoutubeURI(uri) {
        if (!aid.isString(uri))
            throw new TypeError('uri parameter type of string.getObjCheckYoutubeURI() must be String.');
     ...
     */
        ...
        if (!aid.isString(uri))
            throw new TypeError('uri parameter type of string.getObjCheckTwitchURI() must be String.');
